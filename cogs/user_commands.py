...
from config import INVITE_URL, NEXUS_FOOTER

log = logging.getLogger(__name__)

class DeleteDataConfirmView(discord.ui.View):
    def __init__(self, lang: dict, color: int):
    ...
    async def confirm_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        log.info("DSGVO: %s hat seine Daten auf %s unwiderruflich gelöscht.", interaction.user.id, interaction.guild_id)

    @discord.ui.button(style=discord.ButtonStyle.secondary)
    async def cancel_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(
            title=self.lang.get("delete_data_cancelled_title", "Aborted"),
            description=self.lang.get("delete_data_cancelled_desc", "No data was deleted. Everything is secure!"),
...
class UserCommands(commands.Cog):
    ...
    async def invite(self, interaction: discord.Interaction):
        ...
        invite_view.add_item(discord.ui.Button(
        ...
        invite_embed = discord.Embed(
            ...
            description=lang.get("invite_desc", "Manage your server with ease — from leveling and reaction roles to stream alerts and powerful protection with Nexus Shield."),
            color=color,
        )
    ...
    async def delete_my_data(self, interaction: discord.Interaction):
        ...
        warn_embed = discord.Embed(
            ...
            description=lang.get("delete_data_warn_desc", 
        ...
        await interaction.response.send_message(
            embed=warn_embed,
            view=DeleteDataConfirmView(lang, color),
            ephemeral=True
        )
